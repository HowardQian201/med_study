...
def generate_quiz_questions(summary_text, user_id, content_hash, incorrect_question_ids=None, previous_questions=None):
    ...
    # Extract incorrect and correct questions if provided
    incorrect_questions = []
    correct_questions = []
    ...
    for attempt in range(max_retries):
        try:
            ...
            if attempt < max_retries - 1:
                ...
                raise Exception(f"Failed to get valid JSON response from AI after multiple attempts.")
    ...
    raise Exception(f"Failed to generate quiz questions after all retries.")
